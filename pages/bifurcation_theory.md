...
where W​ is a Wiener process and the system is integrated using the **Milstein scheme** for improved accuracy on the noise term. In followed graph you can see the model with a catastrophic bifurcation.
